...
# SPDX-License-Identifier: Apache-2.0
{
  ...
  cfg = config.ghaf.hardware.nvidia.orin.virtualization.host;
in {
  options.ghaf.hardware.nvidia.orin.virtualization.host.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Enable virtualization host support for NVIDIA Orin";
  };
